...
$token = '935790601:AAHwttXzQNLq8LLajDtyfVl5pdixN-kcBRo';
...
$bot->command('start', function ($message) use ($bot) {
    ...
    $message->sendMessage($message->getChat()->getId(), $answer);
});
 ...
 *
 *  Set webhook
 *  https://api.telegram.org/bot935790601:AAHwttXzQNLq8LLajDtyfVl5pdixN-kcBRo/setWebhook?url=https://kubinx.herokuapp.com
 *
 *  Check webhook
